    ...
    return (
      <div className='bg-gray-100 flex items-center justify-center pb-6'>
        <div className='bg-white shadow-lg rounded-lg p-8 w-full text-center'>
          <h3 className='text-2xl font-bold mb-4 bg-gradient-to-r from-blue-800 via-blue-600 to-blue-500 bg-clip-text text-transparent'>
  ...
  return (
    <div className='bg-gray-100 p-6 '>
      <div className='bg-white shadow-lg rounded-lg p-8 mx-auto'>
        <h3 className='text-2xl font-bold text-center mb-6 bg-gradient-to-r from-blue-800 via-blue-600 to-blue-500 bg-clip-text text-transparent border-b border-gray-200 pb-6'>
          Sleep History
        </h3>
