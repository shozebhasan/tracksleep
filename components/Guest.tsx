    ...
    <div className='font-sans bg-gray-100 text-gray-800'>
      ...
      <div className='flex flex-col md:flex-row items-center justify-between p-3 md:p-16 bg-gray-100 pt-20'>
        <div className='flex-1 mb-8 xl:pl-10'>
          <h1 className='text-2xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-blue-800 via-blue-600 to-blue-500 bg-clip-text text-transparent'>
          ...
          <SignInButton>
            <button className='w-full md:w-auto bg-gradient-to-r bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md font-medium cursor-pointer'>
              Get Started
            </button>
          </SignInButton>
        </div>
      ...
      <div className='py-16 px-8 bg-gray-100'>
        ...
        <div className='max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8'>
          <div className='bg-white p-6 rounded-md shadow'>
            ...
            <p className='text-blue-500 font-bold'>- User1</p>
          </div>
          <div className='bg-white p-6 rounded-md shadow'>
            <p className='text-gray-700 mb-4'>
            ...
            <p className='text-blue-500 font-bold'>- User2</p>
          </div>
          <div className='bg-white p-6 rounded-md shadow'>
            <p className='text-gray-700 mb-4'>
            ...
            <p className='text-blue-500 font-bold'>- User3</p>
          </div>
        </div>
      </div>
    </div>
